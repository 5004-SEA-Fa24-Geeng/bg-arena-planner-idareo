...
//
//        for (String multiplePart : multipleParts) {
//            multiplePart = multiplePart.replaceAll(" ", "");
//
//            Operations operator = Operations.getOperatorFromStr(multiplePart);
//            if (operator == null) {
//                return filteredStream;
//            }
//
//            //split into column and value
//            String[] parts = multiplePart.split(operator.getOperator());
//            if(parts.length != 2){
...
//            }
//
//            filteredStream = filteredStream.filter(game -> Filters.filter(game, column, operator, value));
//        }
//        return filteredStream.sorted(getComparator(sortOn));
//    }
//
//    @Override
